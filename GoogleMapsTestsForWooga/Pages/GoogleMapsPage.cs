...
public class GoogleMapsPage : SeleniumWebDriverContainer
{
    ...
    public string SearchInputSelector = "searchboxinput";
    public string SearchButtonSelector = "searchbox-searchbutton";
    ...
    //Header of found place name
    [FindsBy(How = How.XPath, Using = "//*[@id='QA0Szd']//h1//span[contains(text(),'')][1]")]
    [CacheLookup]
    public IWebElement FoundPlaceHeader;
    ...
    //Button for updating information about place
    ...
    [CacheLookup]
    public IWebElement ButtonForAddingPlaceOnMap;


    public List<IWebElement> ActionBarButtons()
    {
        var actionButtons = Driver.FindElements(By.
            CssSelector("div.e07Vkf.kA9KIf > div > div > div:nth-child(4) button")).
            ToList();
        return actionButtons;
    }
    public void SearchFor(string searchCondition)
    {
        WaitForElement(By.Id(SearchInputSelector),
            "Search input is not visible");
        SearchInput.SendKeys(searchCondition);
        WaitForElement(By.Id(SearchButtonSelector),
